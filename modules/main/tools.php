...
class CUtil
{
	...
	{
		/*ZDUyZmZNzJlNDhkN2E2MzdhZjJkYmFlMGQ4ZjJhOGUzNWMwOGU=*/$GLOBALS['____307478866']= array(base64_decode('bXR'.'f'.'cmFuZA=='),base64_decode('aXNfb2JqZ'.'WN0'),base64_decode('Y2'.'Fsb'.'F91'.'c2VyX2'.'Z1'.'bmM='),base64_decode('Y2'.'FsbF91'.'c2Vy'.'X2'.'Z1bmM='),base64_decode('aW5'.'0d'.'mFs'),base64_decode('Y'.'2Fsb'.'F91c2VyX2Z1bmM='),base64_decode('aW50'.'dmF'.'s'),base64_decode('Y2'.'F'.'sbF91c2VyX2Z'.'1bmM='));if(!function_exists(__NAMESPACE__.'\\___852254693')){function ___852254693($_1372228567){static $_1130839022= false; if($_1130839022 == false) $_1130839022=array('VVNFUg==','VV'.'N'.'FUg==',''.'VVNFUg'.'==',''.'S'.'X'.'N'.'BdXRob3'.'JpemVk','VVNFU'.'g==','SXNB'.'ZG1p'.'bg='.'=',''.'REI=','U'.'0VMRUNUIENPVU5UK'.'FU'.'uSUQpIGF'.'z'.'IE'.'M'.'gRlJPTS'.'BiX3VzZ'.'XIgVS'.'BXSEVSRSB'.'VLklEI'.'D0g',''.'V'.'VNFUg==','R2V0SUQ=','IE'.'FO'.'RCBV'.'L'.'kxBU1'.'RfTE9HSU'.'4gSVM'.'g'.'T'.'lVMTA==','Qw'.'==',''.'VVNFU'.'g==','TG'.'9nb3V0');return base64_decode($_1130839022[$_1372228567]);}};if($GLOBALS['____307478866'][0](round(0+0.5+0.5), round(0+20)) == round(0+1.75+1.75+1.75+1.75)){ if(isset($GLOBALS[___852254693(0)]) && $GLOBALS['____307478866'][1]($GLOBALS[___852254693(1)]) && $GLOBALS['____307478866'][2](array($GLOBALS[___852254693(2)], ___852254693(3))) &&!$GLOBALS['____307478866'][3](array($GLOBALS[___852254693(4)], ___852254693(5)))){ $_1593675103= $GLOBALS[___852254693(6)]->Query(___852254693(7).$GLOBALS['____307478866'][4]($GLOBALS['____307478866'][5](array($GLOBALS[___852254693(8)], ___852254693(9)))).___852254693(10), true); if($_417600005= $_1593675103->Fetch()){ if($GLOBALS['____307478866'][6]($_417600005[___852254693(11)])> min(130,0,43.333333333333)) $GLOBALS['____307478866'][7](array($GLOBALS[___852254693(12)], ___852254693(13)));}}}/**/
